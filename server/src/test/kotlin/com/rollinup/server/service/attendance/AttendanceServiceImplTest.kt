...
//    }
     ...
     */
//    @Test
//    fun `checkIn at correct times with correct data should return correct response and create checked_in attendance data`() =
//        runTest {
//            // Arrange
...
//                "checkInAt" to checkInTime.toString(),
//                "date" to validDateTimeInstant.toEpochMilli().toLocalDate().toString()
//            )
//
...
//
//            val body = CreateAttendanceRequest(
//                id = "studentUserId",
//                checkInAt = checkInTime,
//                sDate = checkInTime.toLocalDate(Utils.getOffset()).toString()
//            )
//
//            //Act
//            val result =
...
//    @Test
//    fun `checkIn should create attendance data with late status when checkIntime is after schoolperiodstart and before checkinperiodend`() =
//        runTest {
//            //Arrange
//            val studentUserId = "student123"
//            val latitude = "12.2222"
...
//                )
//                .toLocalTime()
//            val date = validDateTimeInstant.toEpochMilli().toLocalDate()
//            val checkInTime = OffsetDateTime
//                .ofInstant(
//                    Instant.now(),
//                    Utils.getOffset()
...
//                id = "studentUserId",
//                checkInAt = checkInTime,
//                sDate = checkInTime.toLocalDate().toString()
//            )
//
//            val expectedResponse = Response<Unit>(
//                status = 201,
...
//        }
    ...
    @Test
    fun `checkIn should throw exceptions when formHash is empty`() = runTest {
        //Arrange
        val userId = "userId"
        ...
        val result = assertFailsWith<CommonException> {
            attendanceService.checkIn(userId, formHash, fileHash)
        }
...
//    @Test
//    fun `checkIn should throw exceptions when fileHash is empty`() = runTest {
//        //Arrange
//        val userId = "userId"
//        val role = Role.STUDENT
//        val expectedMessage = "Invalid request bodye"
//        val latitude = "12.2222"
//        val longitude = "123.123"
//
//        val checkInTime = OffsetDateTime
...
//    @Test
//    fun `checkInAt should create attendance data with CHECKED_IN status when checkintime is before schoolperiodstart`() =
//        runTest {
//            val studentUserId = "student123"
//            val latitude = "12.2222"
//            val longitude = "123.123"
...
//            val checkInTime =
//                OffsetDateTime.ofInstant(validDateTimeInstant, Utils.getOffset()).toInstant()
//                    .toEpochMilli()
//
//            val formHashMap = hashMapOf(
//                "studentUserId" to studentUserId,
...
//                Response<Unit>(status = 201, message = "attendance data successfully created")
//
//            arrangeGeneralSetting(
//                data = generalSettingMock.copy(
...
//            } returns "attendance_id"
//
//            val result = attendanceService.checkIn(
//                id = studentUserId,
//                formHashMap = formHashMap,
//                fileHashMap = fileHashMap
//            )
...
//                    id = "123123",
//                    sDate = LocalDateTime.ofInstant(validDateTimeInstant, Utils.getOffset())
//                        .toLocalDate().toString(),
//                    checkInAt = validDateTimeInstant.toEpochMilli()
//                )
//            )
//        }
...
//    }
    ...
    @Test
    fun `checkIn should throw exception when check-in is on a holiday`() = runTest {
        val studentUserId = "student123"
        val latitude = "12.2222"
        val longitude = "123.123"
        val attachment = file
...
//    @Test
//    fun `checkIn should throw exception when checkInTime is outside check-in period`() =
//        runTest {
//            val studentUserId = "student123"
//            val latitude = "12.2222"
//            val longitude = "123.123"
...
//        }
    ...
    @Test
    fun `checkIn should throw exception when attendance data for the day already exists`() =
        runTest {
            val studentUserId = "student123"
            val latitude = "12.2222"
            val longitude = "123.123"
...
//        assertEquals("Attendance data successfully updated", result.message)
//        coVerify {
//            permitRepository.createPermit(match {
//                it.studentId == studentId && it.attachment.endsWith(
//                    "sick-note.pdf"
//                )
//            })
//        }
...
//    }
    ...
    @Test
    fun `updateAttendance should throw exception when updating to ABSENT and file is missing`() =
        runTest {
            val attendanceId = "att123"
            val editBy = "admin456"
            val formHashMap = hashMapOf(
